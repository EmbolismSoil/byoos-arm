...
#define UART2_BASE	(AIPS2_ARB_BASE_ADDR + 0x68000)
#define UART3_BASE	(AIPS2_ARB_BASE_ADDR + 0x6C000)
#define UART4_BASE	(AIPS2_ARB_BASE_ADDR + 0x70000)
#define UART5_BASE	(AIPS2_ARB_BASE_ADDR + 0x74000)
